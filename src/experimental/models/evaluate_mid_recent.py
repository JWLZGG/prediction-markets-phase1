...
INPUT_PATH = Path("data/processed/features_mid_recent_enriched.parquet")
PLOT_PATH = Path("reports/calibration_recent_mid.png")
...
def evaluate_mid_recent() -> None:
    ...
    plt.title("Calibration / Reliability Plot (Recent Mid)")
    plt.legend()
    plt.tight_layout()
